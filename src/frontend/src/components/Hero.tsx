        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="animate-on-scroll z-10">
            ...
            <h1 className="mb-6 font-extrabold text-4xl md:text-5xl lg:text-6xl bg-clip-text text-transparent bg-gradient-to-br from-[#1a1a2e] to-[#4361ee]">
              Ship content faster with experienced AI tools
            </h1>
            ...
            {/* Stats Counters with animated counting effect */}
            <div className="grid grid-cols-3 gap-4 mt-12 py-6 px-4 rounded-xl bg-white/60 backdrop-blur-md border border-[#e0e4ff] shadow-sm">
              <div className="text-center">
                <p className="text-3xl font-bold mb-1 counter-animation text-[#1a1a2e]">24 Hours</p>
                <p className="text-sm text-[#4a5568]">Average Delivery</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold mb-1 counter-animation text-[#1a1a2e]">15k+</p>
                <p className="text-sm text-[#4a5568]">Content Pieces</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold mb-1 counter-animation text-[#1a1a2e]">100%</p>
                <p className="text-sm text-[#4a5568]">Satisfaction</p>
              </div>
            </div>
          </div>
